...
public class DashboardSetup {
    ...
    public DashboardSetup(View layoutScreen, Context mContext, AusgabenActivity ausgabenActivity) {
        ...
        this.joinCode = layoutScreen.findViewById(R.id.textReiseCode);
    ...
    public void setUpDashboard() {
        ...
        joinCode.setText(ausgabenReport.getReise().getUniquename());
        joinCode.setOnClickListener(v -> {
            String id = joinCode.getText().toString();
            if (id.isEmpty()) return;
            ClipboardManager clipboard = (ClipboardManager) mContext.getSystemService(Context.CLIPBOARD_SERVICE);
            ClipData clip = ClipData.newPlainText("id", id);
            clipboard.setPrimaryClip(clip);
            Toast.makeText(ausgabenActivity, "Copied to Clipboard", Toast.LENGTH_LONG).show();
        });
